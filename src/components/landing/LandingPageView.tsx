...
export const LandingPageView: React.FC<LandingPageViewProps> = ({ onNavigate }) => {
  const { subjectConfig } = useRevision();
    ...
    <div className="space-y-16 pb-20 animate-fadeIn text-slate-800">
      ...
      <section className="text-center max-w-3xl mx-auto space-y-6 pt-6 sm:pt-12">
        ...
        <p className="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto leading-relaxed">
          Stop passively re-reading hundreds of pages of textbook notes. RecallIQ tracks your <strong>confidence vs. correctness</strong> to pinpoint high-risk misconceptions, schedule your exact remaining hours, and verify mastery with targeted re-tests.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          ...
          >
            <span>Open {subjectConfig.name} Dashboard</span>
        ...
        <div className="pt-4 flex items-center justify-center gap-4 text-xs text-slate-500">
          <div className="flex items-center gap-1.5 font-semibold text-rose-600 bg-rose-50 px-3 py-1 rounded-full border border-rose-200">
            ...
            <span>Target Exam: {subjectConfig.name} • {subjectConfig.hoursUntilExam}h left • {subjectConfig.totalAvailableMinutes}m budget</span>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs space-y-3">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Take a diagnostic assessment on your exam topics. You rate confidence (Low / Med / High) on every choice.
            </p>
          </div>
          ...
          <div className="bg-rose-50/70 border border-rose-200 rounded-3xl p-5 shadow-xs space-y-3">
            ...
            <p className="text-xs text-rose-900/80 leading-relaxed">
              Answered incorrectly with 90% confidence? AI flags it as a lethal exam trap and reveals your flawed mental model.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs space-y-3">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Allocates your remaining study hours into 🔥 High, 🟡 Medium, and 🟢 Low priority micro-sessions across all syllabus modules.
            </p>
          </div>
          ...
          <div className="bg-emerald-50/70 border border-emerald-200 rounded-3xl p-5 shadow-xs space-y-3">
            ...
            <p className="text-xs text-emerald-900/80 leading-relaxed">
              Pass a 2-min targeted re-test to verify that your misconception is resolved, boosting topic mastery dynamically.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-slate-500">
            Exam anxiety happens when you spend 80% of your time re-reading things you already know.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 space-y-3">
            ...
            <ul className="space-y-2.5 text-slate-600">
              ...
              <li className="flex items-start gap-2">
                <span className="text-rose-500 font-bold">✕</span>
                <span>Leaves you guessing what topic to study next</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-indigo-50/60 border border-indigo-200 rounded-2xl p-5 space-y-3">
            ...
            <ul className="space-y-2.5 text-indigo-950 font-medium">
              ...
              <li className="flex items-start gap-2">
                <span className="text-emerald-600 font-bold">✓</span>
                <span><strong>Dynamic Time Budgeting</strong> divides your hours realistically across topics</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-600 font-bold">✓</span>
      ...
      <section className="max-w-4xl mx-auto bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-3xl p-8 text-center space-y-4 shadow-xl">
        <h2 className="text-2xl sm:text-3xl font-black">
          Ready to eliminate your exam blindspots?
        </h2>
        <p className="text-xs sm:text-sm text-slate-300 max-w-xl mx-auto">
          Start with the high-confidence misconception, take the targeted re-test, and watch mastery jump dynamically.
        </p>
        <button
          onClick={handleLaunchDashboard}
